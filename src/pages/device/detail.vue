  ...
  <view class="device-detail-page">
    <view class="head">
      <view class="head-content">
        ...
        <view class="bottom">
          <view class="item" :class="deviceDetail.state === 0 ? 'primary' : 'warning'">设备状态{{$tools.metadata.getText('deviceState', deviceDetail.state)}}</view>
          <view class="item" :class="onlineState === 1 ? 'offline' : 'primary'">{{$tools.metadata.getText('onlineState', deviceDetail.onlineState)}}</view>
        </view>
      </view>
    </view>
    ...
    <view class="tab-content">
      ...
      <view v-else>
        <view class="tab-item" v-for="(item, i) in paramList" :key="i">
          ...
          <view class="right-item middle-block">{{item.value}}</view>
        </view>
      </view>
    </view>
    <view class="service-btn" @click="toPage('/pages/service/service')">服务申报</view>
  </view>
</template>
